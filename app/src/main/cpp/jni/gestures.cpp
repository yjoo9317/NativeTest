...
Java_com_sonos_youngjoopark_nativetest_Gestures_doubleTapNative(JNIEnv *env, jobject instance) {
    if (gGLObject == NULL) {
       return;
    }
    gGLObject->doubleTap();
...
JNIEXPORT void JNICALL
Java_com_sonos_youngjoopark_nativetest_Gestures_scrollNative(JNIEnv *env, jobject instance,
